...
const translations = {
  tr: {
    ...
    proj_all_title:'Tüm Projeler', proj_all_sub:'Geliştirdiğimiz tüm proje ve ürünleri bu sayfada bulabilirsiniz.', proj_back:'← Ana sayfaya dön',
    p1_name:'ClearCut', p1_desc:'Yapay zekâ destekli arka plan kaldırma uygulaması. Görsel yükleyin, arka plan otomatik silinsin; tüm işlem cihazda gerçekleşsin.',
    p2_name:'QR Force', p2_desc:'Her türlü içerik için hızlı QR kod üretme uygulaması. İçeriği girin, hata düzeltme ve boyut ayarını seçin, ardından PNG veya SVG olarak indirin.',
    p3_name:'Renkle', p3_desc:'Rengi görüp ezberleyerek aynı tonu yeniden üretmeye dayalı renk hafıza oyunu. Tahmin doğruluğunu anlık yüzde ile takip edin.',
    p4_name:'Bulls Burger', p4_desc:'Smash burger odaklı restoran markası web sitesi. Menü, şubeler, hikâye ve iletişim alanlarıyla marka deneyimini dijitale taşıyor.',
    p8_name:'Master Emlak', p8_desc:'Gayrimenkulde yeni nesil yaklaşım sunan emlak sitesi. Konut, ticari ve arsa kategorilerinde arama, portföy ve blog içerikleriyle kapsamlı bir deneyim sunuyor.',
    p9_name:'CodeGrid Tools', p9_desc:'PDF, görsel, medya, veri, QR ve metin odaklı ücretsiz online araç platformu. Tüm işlemler tarayıcıda çalışır ve dosyalar sunucuya yüklenmeden güvenli şekilde işlenir.',
    p5_name:'yakında<span class="repo-soon-cursor">_</span>', p5_desc:'Yeni bir proje kartı çok yakında burada olacak.',
    p6_name:'PaletSnap', p6_desc:'Her görselden profesyonel renk paleti çıkaran araç. Baskın renkleri anında ayırır, HEX/RGB/HSL formatında tek tıkla kopyalamanızı sağlar.',
    p7_name:'BaseFlip', p7_desc:'İkili, sekizlik, onluk ve onaltılık sayı sistemleri arasında anında çeviri. Bit görünümü, geçmiş ve hızlı referans tablosu ile birlikte.',
  ...
  en: {
    ...
    proj_all_title:'All Projects', proj_all_sub:'You can find all projects and products we built on this page.', proj_back:'← Back to home',
    p1_name:'ClearCut', p1_desc:'AI-powered background remover app. Upload an image, remove the background automatically, and keep all processing on-device.',
    p2_name:'QR Force', p2_desc:'A fast QR code generator for any content. Enter your text or URL, choose error correction and size, then download as PNG or SVG.',
    p3_name:'Renkle', p3_desc:'A color-memory web game where you recreate the exact color after memorizing it. Track your guess accuracy instantly as a percentage.',
    p4_name:'Bulls Burger', p4_desc:'A brand website for a smash burger restaurant. It brings the menu, branches, story, and contact sections into a cohesive digital experience.',
    p8_name:'Master Emlak', p8_desc:'A real estate website with a next-generation approach. It delivers a complete experience with property search, listings, and blog content across residential, commercial, and land categories.',
    p9_name:'CodeGrid Tools', p9_desc:'A free online tools platform for PDF, image, media, data, QR, and text workflows. Everything runs in the browser and files are processed securely without being uploaded to a server.',
    p5_name:'coming soon<span class="repo-soon-cursor">_</span>', p5_desc:'A new project card will be added here very soon.',
    p6_name:'PaletSnap', p6_desc:'A tool that extracts a professional color palette from any image. It separates dominant colors instantly and lets you copy them in HEX/RGB/HSL formats.',
    p7_name:'BaseFlip', p7_desc:'Instant conversions between binary, octal, decimal, and hexadecimal. Includes bit visualization, history, and a quick reference table.',
